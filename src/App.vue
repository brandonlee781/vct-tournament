...
<template>
  ...
  <main class="md:mt-8">
    ...
    <div v-if="groupTab === 'qualified'" class="grid grid-cols-[3fr,1fr] md:grid-cols-[3fr,1fr,3fr,1fr] gap-2 justify-between">
    ...
    <button v-if="groupTab === 'qualified'" @click="groupTab = 'groups'" class="mt-2 px-3 py-2 hover:bg-[#161616]/40">
      Show Team Groups
    </button>
